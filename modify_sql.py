...
# From: INSERT INTO public.food_entries VALUES ('id', 'date', 'time', 'food_id', weight, NULL, calories, ...)
# To:   INSERT INTO public.food_entries VALUES ('id', 'date', 'time', 'food_id', NULL, weight, NULL, calories, ...)
...
def replace_food_entries(match):
    ...
    rest = match.group(3)  # Everything after weight including NULL and nutrients
...
pattern = r"INSERT INTO public\.food_entries VALUES \(([^)]*'[^']*', '[^']*', '[^']*', '[^']*'), ([^,]*), NULL([^)]*)\);"
