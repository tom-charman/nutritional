...
def test_check_data_quality_returns_report_structure(minimal_data_dict):
    ...
    expected_keys = ['missing_percentages', 'date_gaps', 'total_records', 'date_range', 'is_healthy']
...
def test_check_data_quality_detects_date_gaps(minimal_data_dict):
    ...
    data['dates'] = np.array([
        '2025-01-01', '2025-01-02', '2025-01-05'  # Missing 3 and 4
    ], dtype='datetime64[D]')
...
@pytest.mark.parametrize("plot_name,should_succeed", [
