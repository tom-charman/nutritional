...
def test_prepare_calories_weight_data_raises_error_for_missing_columns(
    minimal_data_dict,
):
...
def test_prepare_normalized_nutrients_data_returns_percentage_keys(
    data_dict_with_nutrients, rdi_guidelines
):
...
def test_prepare_normalized_nutrients_data_normalizes_to_100_percent(
    data_dict_with_nutrients, rdi_guidelines
):
...
def test_prepare_normalized_nutrients_data_raises_error_for_missing_nutrients(
    minimal_data_dict, rdi_guidelines
):
...
def test_calculate_summary_statistics_returns_none_for_missing_columns(
    minimal_data_dict,
):
