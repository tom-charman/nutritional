...
from nutritional.callbacks import serialize_data, deserialize_data
...
def test_update_dashboard_with_empty_date_range():
    ...
    data_dict = {
        'dates': np.array(['2025-01-01', '2025-01-02', '2025-01-03', '2025-01-04', '2025-01-05'], dtype='datetime64[D]'),
        'data': {
        ...
        'columns': ['Calories', 'Weight (morning)', 'Weight (evening)', 'Protein (g)', 'Carbs (g)', 'Saturated Fat (g)', 'Other Fat (g)'],
        'source': 'CSV'
    }
