/**
 * Reset E2E residue in nutritional_test before each run:
 *  - rows on the reserved E2E dates (2024-01-10 .. 2024-01-19 — before any
 *    prod data exists)
 *  - any "E2E "-prefixed foods/meals left by aborted runs
 * Leaves the realistic prod-copy data untouched.
 */
